...
package.preload['ltn12'] = function() return require("socket/ltn12") end
...
function Bitmap:Store(filename)
    ...
    file.data:write('<MA xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://schemas.malighting.de/grandma2/xml/MA" ')
    file.data:write(' xsi:schemaLocation="http://schemas.malighting.de/grandma2/xml/MA http://schemas.malighting.de/grandma2/xml/3.9.60/MA.xsd" ')
    file.data:write('major_vers="3" minor_vers="9" stream_vers="60"><Info datetime="" showfile="" />')
    file.data:write('<UserImage index="1" name="'..name..'" hasTransparency="false" width="'..self.geometry.width..'" height="'..self.geometry.height..'"><Image>')    
...
function Bitmap:UpdateThumbnail(filename)
    ...
    for y = 1, self._height do 
        for x = 1, self._width do
            buffer = buffer .. string.char(self._data[y][x][Bitmap.BLUE], self._data[y][x][Bitmap.GREEN], self._data[y][x][Bitmap.RED], 255)
        end
    end    
...
function Bitmap:UpdateBitmap()
    ...
    local header = string.pack("<c2I2I2I4I4I4I4I4I2I2I4I4I4I4I4I4", 'BM', file_size, 0, 0, off_bits, 
    ...
    for y = 1, height do
        for x = 1, width do                                      
            bitmap = bitmap .. string.char(image[height-y+1][x][BLUE], 
                                           image[height-y+1][x][GREEN], 
